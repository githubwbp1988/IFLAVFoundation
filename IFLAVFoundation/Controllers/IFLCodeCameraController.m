//
//  IFLCodeCameraController.m
//  IFLAVFoundation
//
//  Created by erlich wang on 2022/7/9.
//

#import "IFLCodeCameraController.h"

@interface IFLCodeCameraController () <AVCaptureMetadataOutputObjectsDelegate>

@property(nonatomic, strong)AVCaptureMetadataOutput *metadataOutput; // 通过代理方法，拿到接收元数据时的通知

@end

@implementation IFLCodeCameraController
...
- (BOOL)setupSessionOutputs:(NSError **)error {
    ...
    if ([self.captureSession canAddOutput:self.metadataOutput]) {
        ...
        *error = [NSError errorWithDomain:IFLCameraErrorDomain code:IFLCameraErrorFailedToAddOutput userInfo:userInfo];
...
- (void)captureOutput:(AVCaptureOutput *)output didOutputMetadataObjects:(NSArray<__kindof AVMetadataObject *> *)metadataObjects fromConnection:(AVCaptureConnection *)connection {
    ...
    if (self.codeDetectionDelegate && [self.codeDetectionDelegate respondsToSelector:@selector(didDetectCodes:)]) {
