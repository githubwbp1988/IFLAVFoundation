//
//  IFLCodePreviewView.m
//  IFLAVFoundation
//
//  Created by erlich wang on 2022/7/9.
//

#import "IFLCodePreviewView.h"
#import "IFLCodeCameraController.h"

@interface IFLCodePreviewView () <IFLCodeDetectionDelegate>

@property(strong,nonatomic)NSMutableDictionary *codeLayers;     // 二维码图层

@end

@implementation IFLCodePreviewView

#pragma mark - IFLCodeDetectionDelegate
// 元数据转换
